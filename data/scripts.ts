...
const scripts: ScriptItem[] = [
  ...
  {
    slug: 'chat-system-beta',
    title: 'Chat Systems',
    category: 'utility',
    categoryLabel: 'Regular',
    thumbnail: '/images/scripts/chat-thumb.jpg',
    cover: '/images/scripts/chat-cover.png',
    youtubeId: '3y1ayGNqGy8',
    summary: 'ระบบแชท /me /do แบบสมจริง แสดงข้อความเหนือหัวผู้เล่นแบบเรียลไทม์',
    description: 'ระบบแชท /me และ /do สำหรับ FiveM ที่ออกแบบมาให้ใช้งานง่ายและสมจริง แสดงข้อความแบบ 3D เหนือหัวผู้เล่นพร้อมเอฟเฟกต์ที่ลื่นไหล รองรับการแสดงผลเฉพาะระยะใกล้เพื่อเพิ่มความ immersive และลดความรกของหน้าจอ สามารถปรับแต่งรูปแบบ ขนาด และระยะการแสดงผลได้ผ่าน config เหมาะสำหรับเซิร์ฟเวอร์ RP ที่ต้องการประสบการณ์การเล่นที่ดูเป็นธรรมชาติและมืออาชีพ',
    shortInfo: 'chat system showcase',
    framework: 'QBCore',
    status: 'Beta',
    featured: false,
    features: [
      '3D text above player',
    ...
    gallery: [
      '/images/scripts/chat-1.jpeg',
      '/images/scripts/chat-2.jpg',
    ],
  },
  {
    slug: 'helicom-system-beta',
    title: 'Helicom Systems',
    category: 'apocalypse',
    categoryLabel: 'Apocalypse',
    ...
    'Custom pickup/drop points',
    'Smooth cinematic travel',
    'Interactive E key usage',
    'Configurable locations',
  ],
    gallery: [
      '/images/scripts/helicom-1.jpeg',
      '/images/scripts/helicom-2.jpg',
    ],
  },
  // {
  //   slug: 'warz-hud',
